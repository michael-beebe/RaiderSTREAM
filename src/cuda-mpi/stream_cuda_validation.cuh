#ifndef STREAM_CUDA_VALIDATION_H
#define STREAM_CUDA_VALIDATION_H
...
void stream_validation(ssize_t array_elements, STREAM_TYPE scalar, int *is_validated, STREAM_TYPE *a, STREAM_TYPE *b, STREAM_TYPE *c, int myrank, int numranks) {
    ...
    validate_values(aj, bj, cj, array_elements, a, b, c, myrank, numranks, AvgErr, STREAM);
    MPI_Gather(AvgErr, NUM_ARRAYS, MPI_DOUBLE, AvgErrByRank, NUM_ARRAYS, MPI_DOUBLE, 0, MPI_COMM_WORLD);
...
void gather_validation(ssize_t array_elements, STREAM_TYPE scalar, int *is_validated, STREAM_TYPE *a, STREAM_TYPE *b, STREAM_TYPE *c, int myrank, int numranks) {
    ...
    validate_values(aj, bj, cj, array_elements, a, b, c, myrank, numranks, AvgErr, GATHER);
    MPI_Gather(AvgErr, NUM_ARRAYS, MPI_DOUBLE, AvgErrByRank, NUM_ARRAYS, MPI_DOUBLE, 0, MPI_COMM_WORLD);
...
void scatter_validation(ssize_t array_elements, STREAM_TYPE scalar, int *is_validated, STREAM_TYPE *a, STREAM_TYPE *b, STREAM_TYPE *c, int myrank, int numranks) {
    ...
    validate_values(aj, bj, cj, array_elements, a, b, c, myrank, numranks, AvgErr, SCATTER);
    MPI_Gather(AvgErr, NUM_ARRAYS, MPI_DOUBLE, AvgErrByRank, NUM_ARRAYS, MPI_DOUBLE, 0, MPI_COMM_WORLD);
...
void sg_validation(ssize_t array_elements, STREAM_TYPE scalar, int *is_validated, STREAM_TYPE *a, STREAM_TYPE *b, STREAM_TYPE *c, int myrank, int numranks) {
	STREAM_TYPE aj,bj,cj;
    STREAM_TYPE AvgErr[NUM_ARRAYS], AvgErrByRank[NUM_ARRAYS * numranks];
    int err = 0;
    ...
    validate_values(aj, bj, cj, array_elements, a, b, c, myrank, numranks, AvgErr, SG);
    MPI_Gather(AvgErr, NUM_ARRAYS, MPI_DOUBLE, AvgErrByRank, NUM_ARRAYS, MPI_DOUBLE, 0, MPI_COMM_WORLD);
...
void central_validation(ssize_t array_elements, STREAM_TYPE scalar, int *is_validated, STREAM_TYPE *a, STREAM_TYPE *b, STREAM_TYPE *c, int myrank, int numranks) {
	STREAM_TYPE aj,bj,cj;
    STREAM_TYPE AvgErr[NUM_ARRAYS], AvgErrByRank[NUM_ARRAYS * numranks];
    int err = 0;
	...
	validate_values(aj, bj, cj, array_elements, a, b, c, myrank, numranks, AvgErr, CENTRAL);
	MPI_Gather(AvgErr, NUM_ARRAYS, MPI_DOUBLE, AvgErrByRank, NUM_ARRAYS, MPI_DOUBLE, 0, MPI_COMM_WORLD);
