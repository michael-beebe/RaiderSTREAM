...
__global__ void stream_copy(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, ssize_t stream_array_size) {
	ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
	if(j < stream_array_size) d_c[j] = d_a[j];
}

__global__ void stream_scale(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, STREAM_TYPE scalar, ssize_t stream_array_size) {
    ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
	if(j < stream_array_size) d_b[j] = scalar * d_c[j];
}

__global__ void stream_sum(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, ssize_t stream_array_size) {
    ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
	if(j < stream_array_size) d_c[j] = d_a[j] + d_b[j];
}

__global__ void stream_triad(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, STREAM_TYPE scalar, ssize_t stream_array_size) {
    ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void gather_copy(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, ssize_t* __restrict__ d_IDX1, ssize_t* __restrict__ d_IDX2,
...
__global__ void gather_scale(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, STREAM_TYPE scalar, ssize_t* __restrict__ d_IDX1,
	ssize_t* __restrict__ d_IDX2, ssize_t stream_array_size)
{
    ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
	if(j < stream_array_size) d_b[j] = scalar * d_c[d_IDX2[j]];
}

__global__ void gather_sum(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, ssize_t* __restrict__ d_IDX1, ssize_t* __restrict__ d_IDX2,
	ssize_t stream_array_size)
{
    ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void gather_triad(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, STREAM_TYPE scalar, ssize_t* __restrict__ d_IDX1,
	ssize_t* __restrict__ d_IDX2, ssize_t stream_array_size)
{
    ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void scatter_copy(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, ssize_t* __restrict__ d_IDX1, ssize_t* __restrict__ d_IDX2,
	ssize_t stream_array_size)
{
	ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void scatter_scale(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, STREAM_TYPE scalar, ssize_t* __restrict__ d_IDX1,
	ssize_t* __restrict__ d_IDX2, ssize_t stream_array_size)
{
    ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void scatter_sum(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, ssize_t* __restrict__ d_IDX1, ssize_t* __restrict__ d_IDX2,
	ssize_t stream_array_size)
{
    ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void scatter_triad(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, STREAM_TYPE scalar, ssize_t* __restrict__ d_IDX1,
	ssize_t* __restrict__ d_IDX2, ssize_t stream_array_size)
{
    ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
				   ...
				   double times[NUM_KERNELS][NTIMES], ssize_t stream_array_size, STREAM_TYPE scalar, int is_validated[NUM_KERNELS])
{
	...
	for(auto k = 0; k < NTIMES; k++) {
		cudaEventRecord(t0);
		<<< (stream_array_size + 255)/256, 256 >>>(d_a, d_b, d_c, d_IDX1, d_IDX2, stream_array_size);
		cudaEventRecord(t1);
...
__global__ void sg_copy(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, ssize_t* __restrict__ d_IDX1, ssize_t* __restrict__ d_IDX2,
	ssize_t* __restrict__ d_IDX3, ssize_t stream_array_size)
{
	ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
	if(j < stream_array_size) d_c[d_IDX1[j]] = d_a[d_IDX2[j]];
}

__global__ void sg_scale(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, STREAM_TYPE scalar, ssize_t* __restrict__ d_IDX1,
	ssize_t* __restrict__ d_IDX2, ssize_t* __restrict__ d_IDX3, ssize_t stream_array_size)
{
	ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
	if(j < stream_array_size) d_b[d_IDX2[j]] = scalar * d_c[d_IDX1[j]];
}

__global__ void sg_sum(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, ssize_t* __restrict__ d_IDX1, ssize_t* __restrict__ d_IDX2,
	ssize_t* __restrict__ d_IDX3, ssize_t stream_array_size)
{
    ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void sg_triad(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, STREAM_TYPE scalar, ssize_t* __restrict__ d_IDX1,
	ssize_t* __restrict__ d_IDX2, ssize_t* __restrict__ d_IDX3, ssize_t stream_array_size)
{
    ssize_t j = blockIdx.x * blockDim.x + threadIdx.x;
...
__global__ void central_copy(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, ssize_t stream_array_size) {
	d_c[0] = d_a[0];
}

__global__ void central_scale(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, STREAM_TYPE scalar, ssize_t stream_array_size) {
	d_b[0] = scalar * d_c[0];
}

__global__ void central_sum(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, ssize_t stream_array_size) {
	d_c[0] = d_a[0] + d_b[0];
}

__global__ void central_triad(STREAM_TYPE* __restrict__ d_a, STREAM_TYPE* __restrict__ d_b,
	STREAM_TYPE* __restrict__ d_c, STREAM_TYPE scalar, ssize_t stream_array_size) {
