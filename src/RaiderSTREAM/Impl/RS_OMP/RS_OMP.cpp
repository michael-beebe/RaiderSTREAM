...
/**************************************************
 * @brief Constructor for the RS_OMP class.
 *
 * Initializes the RS_OMP object with the specified options.
 *
 * @param opts Options for the RS_OMP object.
 **************************************************/
 ...
 **************************************************/
bool RS_OMP::allocateData(double *allocTime, double *initTime, double *randomGenTime) {
  double startTime;
...
**/
void RS_OMP::collectChunks (double * collectTime){
  *collectTime = 0;
}
